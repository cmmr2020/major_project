...
Page({
  ...
  onLoad: function(e) {
    ...
    that.setData({
      ...
      fontSize:fontSize,
      bgColor:bgColor,
      isHeadman:e.isHeadman,
      fontSize35:parseInt(fontSize)+4,
      fontSize28:parseInt(fontSize)-2,
      terminalUserName:app.data.terminalUserName
    })
  ...
  detail: function() {
    ...
    app.wxRequest(
      'GET',
      requestUrl + "/mobile/fieldTask/getTaskGroupResourceByMoblie",
      {
        'projectId': projectId,
        'taskId': taskId
      },
      ...
      (res) =>{
        ...
        if (res.data.status === "success") {
          ...
          var videos = [];
          var audios = [];
          var answerResourceList = data.answerResourceList
          ...
          var videos_dep = [];
          var audios_dep = [];
          var taskResourceList = data.taskUserResourceList
          ...
          var departmentName = res.data.retObj.terminalUserName
          that.setData({
            ...
            departmentName:departmentName.indexOf('#') == -1?departmentName:departmentName.split('#')[1],
            deptAuditContent:res.data.retObj.deptAuditContent,
            groupAuditContent:res.data.retObj.groupAuditContent,
            mobile_userId:res.data.retObj.mobile_userId
...
    })
  ...
  process_fun:function(e){
    ...
    if(result_type == 0){
      ...
      app.wxRequest(
        'POST',
        that.data.requestUrl + "/mobile/fieldTask/deptGroupCheckByMobile",
        param,
        app.seesionId,
        (res) =>{
          console.log(res)
