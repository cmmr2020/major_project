...
Page({
  ...
  onLoad: function (option) {
    ...
    var isDepartType = option.isDepartType;
  ...
  getDissentFieldTaskList: function (pageSize,pageScrollto_id) {
    ...
    app.wxRequest(
      'GET',
      requestUrl + '/mobile/fieldTask/getDissentListByMoblie',//"/fieldTask/getDissentList.json",
      that.data.task_request_dataParam,
      app.seesionId,
      (res) => {
        if (res.data.status === "success") {
  ...
  batch_process: function (e) {
    ...
    app.wxRequest(
      'POST',
      that.data.requestUrl + "/mobile/fieldTask/batchCheckByMoblie",
      param,
      app.seesionId,
      (res) => {
        console.log(res)
