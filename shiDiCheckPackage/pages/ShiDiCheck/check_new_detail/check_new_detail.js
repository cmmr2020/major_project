...
Page({
  ...
  detail: function () {
    ...
    app.wxRequest(
      ...
      //   'taskId': taskId
      // },
      requestUrl + "/mobile/fieldTask/getFieldTaskDetailByNew",
      {
        'projectId': projectId,
        'id': taskId
      },
  ...
  process_fun: function (e) {
    ...
    app.wxRequest(
      'POST',
      that.data.requestUrl + "/mobile/fieldTask/checkTaskByNew",
      param,
      app.seesionId,
      (res) => {
        console.log(res)
    ...
    wx.showModal({
      ...
      success(res) {
        if (res.confirm) {
          ...
          app.wxRequest(
            'POST',
            that.data.requestUrl + "/mobile/fieldTask/refuseByMobile",
            param,
            app.seesionId,
            (res) => {
              console.log(res)
  ...
  open_update_dept_page: function (e) {
    ...
    app.wxRequest(
      'POST',
      that.data.requestUrl + "/mobile/fieldTask/getDepartmentListByProjectId",
  ...
  updateDept: function (e) {
    ...
    if (isDepartType == 1) {//朝阳模式
      if (!that.data.select_lead_deptIds) {
        app.alert('请选择牵头单位')
        return
      }
      param.leadDeptIds = that.data.select_lead_deptIds
      param.deptIds = that.data.select_deptIds
    } else {//普通模式
    ...
    app.wxRequest(
      'POST',
      that.data.requestUrl + "/mobile/fieldTask/updateTaskDepartmentByNew",
      param,
      app.seesionId,
      (res) => {
        //console.log(res)
