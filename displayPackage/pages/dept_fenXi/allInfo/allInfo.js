...
Page({
  ...
  onLoad: function (options) {
    ...
    let that = this
    let deptId = app.data.departmentId;
    that.initQuotaInfo(deptId)
    that.initPointInfo(deptId)
    that.inintchar1(deptId)
    that.inintchar2(deptId)
    //that.inintchar3()
    that.inintchar4(deptId)
    that.inintchar5(deptId)
    //that.inintPic(deptId)
  },
  hideModal(e) {
    this.setData({
      IsShowInfo:false
