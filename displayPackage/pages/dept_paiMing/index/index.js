...
Page({
  ...
  onLoad: function (options) {
    this.data.dept_select_ids = app.data.departmentId;
  ...
  jump: function(option){
    ...
    if(type == 'dept'){
      wx.navigateTo({
        url: '../deptDataInfo/deptDataInfo?reportType=0&projectId='+that.data.projectId+"&projectName="+that.data.projectName+"&deptIds="+that.data.dept_select_ids+"&pointIds="+that.getStrs(that.data.point_select_ids)+"&quotaTypeIds="+that.getStrs(that.data.quotaType_select_ids)
      })
    }else if(type == 'quota'){
      wx.navigateTo({
        url: '../quotaDataInfo/quotaDataInfo?reportType=1&projectId='+that.data.projectId+"&projectName="+that.data.projectName+"&deptIds="+that.data.dept_select_ids+"&pointIds="+that.getStrs(that.data.point_select_ids)+"&quotaTypeIds="+that.getStrs(that.data.quotaType_select_ids)
      })
    }else if(type == 'location'){
      wx.navigateTo({
        url: '../deptDataInfo/deptDataInfo?reportType=2&projectId='+that.data.projectId+"&projectName="+that.data.projectName+"&deptIds="+that.data.dept_select_ids+"&pointIds="+that.getStrs(that.data.point_select_ids)+"&quotaTypeIds="+that.getStrs(that.data.quotaType_select_ids)
      })
    }else if(type == 'abarbeitung'){
      wx.navigateTo({
        url: '../deptDataInfo/deptDataInfo?reportType=3&projectId='+that.data.projectId+"&projectName="+that.data.projectName+"&deptIds="+that.data.dept_select_ids
      })
    }
  },
  getStrs(arr){
